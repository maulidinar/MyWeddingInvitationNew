                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;" class="nav" align="right" style="font:bold 13px/15px Arial, Helvetica, sans-serif; color:#888;">
                                  <a target="_blank" style="text-decoration:none; color:#888;" href="#">Home</a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="#">Bantuan</a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="#">Contact</a>
                                </td>
                              </tr>
                            </table>
                          </th>
                  ...
                  <tr>
                    <td data-bgcolor="bg-block" class="holder" style="padding:20px 60px 52px;" bgcolor="#f9f9f9">
                      <table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:bold 16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 13px;">
                            <h1 style="font-size: 3rem;font-weight: bold;">{{ $details['show'] }}</h1>
							<p style="margin-top: -24px;">Tgl : {{ \Carbon\Carbon::parse($details['show_date_start'] )->format('d-m-Y') }} s/d {{ \Carbon\Carbon::parse($details['show_date_end'] )->format('d-m-Y') }}</p><br>
							Hai, {{ $details['name'] }} selamat pembelian tiket anda sudah di Approve
							berikut kode tiket anda :

							<h1>{{ $details['body'] }}</h1>
                           <br>
                           <br>
                           NOTE : Simpan kode tiket ini untuk di tukar dengan minuman
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Berikut Juga kami lampirkan QR-CODE Tiket
