        ...
        <div class="intro-y box py-10 sm:py-20 mt-5" style="border-radius: 20px">
            <div class="wizard flex flex-col lg:flex-row justify-center px-5 sm:px-20 w-64">
                ...
                <div class="intro-x lg:text-center flex items-center mt-5 lg:mt-0 lg:block flex-1 z-10">
                    ...
                    <div class="lg:w-32 font-medium text-base lg:mt-3 ml-3 lg:mx-auto ">Pembayaran</div>
                </div>
                {{-- <div class="intro-x lg:text-center flex items-center mt-5 lg:mt-0 lg:block flex-1 z-10">
            ...
            <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200">
                ...
                <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                    <div class="intro-y col-span-12 sm:col-span-6">
                        <div class="intro-y col-span-6 sm:col-span-4 md:col-span-6 xxl:col-span-2">
                            <div class="intro-y flex-1 box py-10 lg:ml-5 mb-5 lg:mb-0">
                                ...
                                <h4 style="font-weight: bold;color: red">Sisa Tiket {{ $data->quota }}</h4>
                    ...
                    {{-- step 2 --}}
                    <div class="intro-y col-span-12 sm:col-span-6">
                        <form data-single="true" action="user-payment" method="POST" class="border-gray-200 border-dashed" enctype="multipart/form-data">
                            @csrf
                        <input type="hidden" name="user_id" value="{{ $id_customer }}">
                        <input type="hidden" name="ticket_id" value="{{ $ticket_id }}">
                        
                            
                            <div class="dz-message" data-dz-message style="margin-top: 10%;margin-bottom: 20%">
                                <div class="text-lg font-medium">Silahkan upload file bukti pembayaran.</div>
                        ...
                        {{-- <form action="user-save" method="POST">
                            @csrf
                        <div class="font-medium text-base">Silahkan Upload Bukti Pembayaran</div>
                        <br>
