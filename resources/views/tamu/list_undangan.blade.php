...
@section('content')
     ...
     <div class="content">
        ...
        <p>Pilih undangan untuk kelola tamu</p>
                        ...
                        <tr>
                            ...
                            <td class="table-report__action w-auto ">
                                <div class="open-edit flex items-center mr-3"  style="float: right"> 
                                    <a href="{{ URL::to('/list-tamu/'.$value->id) }}">
                                    <button class="button w-32 mr-2 mb-2 flex items-center justify-center border border-theme-1 text-theme-1"> 
                                        <i data-feather="edit" class="w-4 h-4 mr-2"></i> Kelola Tamu </button> </a>
                                </div>
